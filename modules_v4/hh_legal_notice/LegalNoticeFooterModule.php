...
implements ModuleCustomInterface, ModuleFooterInterface, ModuleConfigInterface
{
    ...
    public function __construct()
    {
        ...
        parent::__construct($this->moduleService);
    }
    ...
    public function migratePreferencesFromFormerModule(): void
    {
        ...
        if ($updated_settings) {
            ...
            $message = I18N::translate(
                'The preferences for the custom module "%s" were imported from the earlier custom module "%s".',
                $this->title(),
                self::OLD_MODULE_NAME_FOR_PREFERENCES
            );
    ...
    public function getPageAction(ServerRequestInterface $request): ResponseInterface
    {
        ...
        return $this->viewResponse($this->name() . '::page', [
            ...
            'commentAdministrators'     => I18N::plural(
                'The webtrees administrator is responsible to manage users and to set the preferences for this website.',
                'The webtrees administrators are responsible to manage users and to set the preferences for this website.',
                count($contactsAdministrators)
            ),
